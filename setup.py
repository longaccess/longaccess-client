...
setup(version=pep386adapt(__version__),
      ...
      install_requires=['boto>=2.13.2', 'python-dateutil', 'filechunkio',
                        'docopt', 'progressbar>=2.3', 'logutils', 'requests',
                        'unidecode', 'pycrypto', 'pyaml', 'Twisted', 'crochet',
                        'treq>=0.2.0', 'pyOpenSSL', 'thrift', 'blessings'],
      dependency_links = [
        'https://github.com/kouk/treq/tarball/fixauth#egg=treq-0.2.0fixed',
        'https://github.com/longaccess/python-progressbar/tarball/master#egg=progressbar-2.3fixed',
      ],
